...
export function displayHelp() {
  ...
  console.log('');
  console.log(chalk.green('  # Análisis con opciones avanzadas'));
  console.log(chalk.white('  grafo indexer analyze -s ./solution.sln -o ./results --verbose'));
  console.log('');
  console.log(chalk.green('  # Ejecutar suite completa de tests'));
  console.log(chalk.white('  grafo test run --verbose'));
  console.log('');
